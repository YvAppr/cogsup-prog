...
from expyriment.misc.constants import C_WHITE, C_BLACK, C_BLUE, C_GREEN, C_RED, C_EXPYRIMENT_ORANGE, K_r, K_b, K_o, K_g, K_LSHIFT

# work in association with Lou Mallet
